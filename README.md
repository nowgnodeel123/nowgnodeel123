...
Java와 Spring Boot로 API를 개발합니다. 현재는 Siemens Teamcenter Active Workspace(AWC) 환경에서 화면 커스터마이징과 SOA API 연동 업무를 하고 있습니다.

동서대학교 소프트웨어학과를 졸업하고 메가존클라우드 Java 개발자 양성 과정을 수료한 뒤, SI 프로젝트에서 데이터 마이그레이션과 PLM 화면 개발을 경험했습니다.
