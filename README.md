...
![Teamcenter AWC](https://img.shields.io/badge/Teamcenter_AWC-009999?style=flat-square&logo=siemens&logoColor=white)

`Oracle` `AWS Lambda` `API Gateway` `DynamoDB` `S3` `Oracle Cloud` `SOA API`
